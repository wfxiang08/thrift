...
class Client(shared.SharedService.Client, Iface):
    ...
    def add(self, num1, num2):
        ...
        Parameters:
         - num1
         - num2
        正常提供给用户的方法由两部分组成: send_xxx, recv_xxx
        """
    ...
    def recv_calculate(self):
        ...
        # 失败之后, ouch是做什么的?
        # ouch应该是服务器端反馈回来的Exception
        # 参考函数定义: # i32 calculate(1:i32 logid, 2:Work w) throws (1:InvalidOperation ouch),
        #
